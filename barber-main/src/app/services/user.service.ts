...
export class UserService{
    ...
    getAllDeleted():Observable<DataResponse<User[]>>{
      return this.httpClient.get<DataResponse<User[]>>(environment.getApiUrl(`/users/get-all-deleted`))
    }

    getAllNotDeleted():Observable<DataResponse<User[]>>{
      return this.httpClient.get<DataResponse<User[]>>(environment.getApiUrl(`/users/get-all-not-deleted`))
    }
    ...
    hardDeleteById(userId:number):Observable<Response>{
        return this.httpClient.delete<Response>(environment.getApiUrl("/users/hard-delete-by-id/"+userId));
    }

    restoreById(userId:number):Observable<Response>{
        return this.httpClient.delete<Response>(environment.getApiUrl("/users/restore-by-id/"+userId));
    }
